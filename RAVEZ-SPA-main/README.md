...
<tbody>
  ...
  <tr>
   ...
   <tr>
    <td colspan="4"><h3 align="center">Comment Endpoints <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Hourglass%20Not%20Done.png" alt="Hourglass Not Done" width="28" height="28" align="center" /></h3></td>
  </tr>
  <tr>
    <td align="center">Method</td>
    <td align="center">Description</td>
  ...
  <tr>
    <td>GET</td>
    <td>Get all comments on a specific thread post with the given offset, limit and sortBy which also will be part of infinite scrolling</td>
    <td>http://localhost:3000/v1/thread/comments/{thread_id}?limit=10&offset=0&sortBy=created_at</td>
    <td align="center">🔧</td>
  </tr>
  <tr>
    <td>GET</td>
    <td>Get all replies on a specific thread comment with the given offset, limit and sortBy which also will be part of infinite scrolling, this is also the last barrier of recursion</td>
    <td>http://localhost:3000/v1/thread/comment-replies/{thread_id}?limit=10&offset=0&sortBy=created_at</td>
    <td align="center">🔧</td>
  </tr>
  <tr>
    <td>POST</td>
    <td>Create a comment for the specific thread parent</td>
    <td>http://localhost:3000/v1/thread/comment/{account_id}</td>
    <td align="center">🔧</td>
  </tr>
  <tr>
    <td>POST</td>
    <td>Create a reply for the specific thread comment as for the parent comment</td>
    <td>http://localhost:3000/v1/thread/comment-reply/{account_id}</td>
    <td align="center">🔧</td>
  </tr>
  <tr>
    <td>DELETE</td>
    <td>Delete a specific personal logged in user comment</td>
    <td>http://localhost:3000/v1/thread/remove-comment/{thread_id}</td>
    <td align="center">🔧</td>
  </tr>
</tbody></table>
